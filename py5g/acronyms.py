acronyms = {
    ...
    "5GS": ['5G System'],
    "8-PSK": ['8-state Phase Shift Keying', 'Authentication Centre'],
    ...
    "CA": ['Capacity Allocation', 'Cell Allocation', 'Certification Authority'],
    "C-APDU": ['Command APDU'],
    ...
    "CC": ['Call Control', 'Country Code', 'Cryptographic Checksum', 'Component Carrier'],
    ...
    "CCM": ['Certificate Configuration Message', 'Current Call Meter'],
    ...
    "CF": ['Conversion Facility', 'all Call Forwarding services'],
    "CFB": ['Call Forwarding on mobile subscriber Busy'],
    "CFN": ['Connection Frame Number'],
    "CFNRc": ['Call Forwarding on mobile subscriber  Not Reachable'],
    "CFNRy": ['Call Forwarding on No Reply'],
    "CFU": ['Call Forwarding Unconditional'],
    "CGI": ['Common Gateway Interface', 'Cell Global Identifier'],
    "CHAP": ['Challenge Handshake Authentication Protocol'],
    "CHP": ['CHarging Point'],
    "CHV": ['Card Holder Verification information'],
    "CI": ['Cell Identity', 'CUG index'],
    ...
    "CT": ['Call Transfer supplementary service', 'Channel Tester', 'Channel Type'],
    ...
    "CW": ['Call Waiting', 'Continuous Wave (unmodulated signal)'],
    ...
    "DB": ['Dummy Burst'],
    "DC": ['Dedicated Control (SAP)', 'Direct Current'],
    ...
    "DISC": ['Disconnect'],
    "DL": ['Data Layer', 'Downlink (Forward Link)'],
    ...
    "ECC": ['Emergency Call Code', 'Elliptic Curve Cryptography'],
    ...
    "ECM": ['Error Correction Mode (facsimile)', 'EPS Connection Management'],
    ...
    "EIR": ['Equipment Identity Centre', 'Equipment Identity Register'],
    ...
    "EPC": ['Enhanced Power Control', 'Evolved Packet Core'],
    "EPRE": ['Energy Per Resource Element'],
    "E-UTRA": ['Evolved UTRA', 'Evolved Universal Terrestrial Radio Access'],
    ...
    "ERP": ['Ear Reference Point', 'Equivalent Radiated Power'],
    "ERR": ['Error'],
    ...
    "FA": ['Full Allocation', 'Fax Adaptor'],
    ...
    "IC": ['Integrated Circuit', 'Interlock Code (CUG SS)'],
    ...
    "IN": ['Intelligent Network', 'Interrogating Node'],
    ...
    "LA": ['Location Area'],
    "LAC": ['Link Access Control', 'Location Area Code'],
    ...
    "LE": ['Local Exchange'],
    "LEN": ['LENgth'],
    "LI": ['Language Indication', 'Lawful Interception', 'Length Indicator', 'Line Identity'],
    ...
    "LR": ['Location Register', 'Location Registration'],
    "LSA": ['Localised Service Area'],
    "LSB": ['Least Significant Bit'],
    "LSTR": ['Listener SideTone Rating'],
    "LTE": ['Local Terminal Emulator', 'Long Term Evolution'],
    "LTZ": ['Local Time Zone'],
    "LU": ['Local Units', 'Location Update'],
    "LV": ['Length and Value'],
    ...
    "MM": ['Man Machine', 'Mobility Management', 'Multimedia'],
    ...
    "NEV": ['NEVer'],
    "NF": ['Network Function'],
    "NGCN": ['Next Generation Corporate Network (TSs originating pre-Release-15)', 'Next Generation Core Network (TSs originating Release 15 onwards)'],
    ...
    "PD": ['Protocol Discriminator', 'Public Data'],
    ...
    "PG": ['Processing Gain'],
    "PH": ['Packet Handler', 'PHysical (layer)'],
    ...
    "PI": ['Page Indicator', 'Presentation Indicator'],
    ...
    "PS": ['Packet Switched', 'Location Probability'],
    "PSC": ['Primary Synchronisation Code', 'Packet Scheduling'],
    ...
    "PW": ['Pass Word'],
    "PWS": ['Public Warning System', 'Random Access Burst'],
    ...
    "RF": ['Radio Frequency'],
    "RFC": ['Request For Comments', 'Radio Frequency Channel'],
...
Received Signal Quality": [''],
    ...
    "SDP": ['Service Discovery Protocol (Bluetooth related)', 'Session Description Protocol'],
    "SDT": ['SDL Development Tool'],
    "SDU": ['Service Data Unit'],
    "SE": ['Security Environment', 'Sending Entity', 'Support Entity'],
    ...
    "SI": ['Screening Indicator', 'Service Interworking', 'Supplementary Information (SIA = Supplemenatary Information A)', 'System Information'],
    ...
    "SN": ['Serial Number', 'Serving Network', 'Sequence Number', 'Subscriber Number'],
    "SNDCP": ['Sub-Network Dependent Convergence Protocol'],
    "SNMP": ['Simple Network Management Protocol'],
    "SNR": ['Serial NumbeR', 'Signal-to-Noise Ratio'],
    "SOA": ['Suppress Outgoing Access (CUG SS)'],
    "SoLSA": ['Support of Localised Service Area'],
    "SON": ['Self Organizing Networks'],
    "SoR": ['Steering of Roaming'],
    "SP": ['Switching Point', 'Service Provider'],
    "SPC": ['Signalling Point Code', 'Suppress Preferential CUG'],
    ...
    "SS": ['Supplementary Service', 'System Simulator'],
    "SS7": ['Signalling System No. 7'],
    "SSC": ['Secondary Synchronisation Code', 'Supplementary Service Control string'],
    ...
    "SW": ['Status Word', 'Software'],
    "SW1/SW2": ['Status Word 1/Status Word 2'],
    "T-SGW": ['Transport Signalling Gateway'],
    "T": ['Timer', 'Transparent', 'Type only'],
    "TA": ['Terminal Adaptation', 'Timing Advance', 'Tracking Area'],
    ...
    "TC": ['Transaction Capabilities', 'TransCoder', 'Transmission Convergence'],
    "TCH": ['Traffic Channel'],
    "TCH/F": ['A full rate TCH', '≤'],
    "TCH/F2,4": ['2,4kbit/s) \nA full rate data TCH ('],
    ...
    "TFI": ['Transport Format Indicator', 'Temporary Flow Identity'],
    ...
    "TRX": ['Transceiver'],
    "TS": ['Technical Specification', 'Teleservice', 'Time Slot'],
